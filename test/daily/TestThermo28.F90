...
program TestThermo28
    ...
    ! Init test values
    dGibbsCheck            = -1.28092D05
    dHeatCapacityCheck     = 679.088
    nSpeciesTest           = 4
    iSpeciesIndexTest      = [1, 2, 14, 15] !Tc, Pd, Tc, Pd
    dMolFractionTest       = [5.99165D-11, 8.25169D-05, 4.41759D-01, 9.03579D-01]
    lPass                  = .FALSE.
