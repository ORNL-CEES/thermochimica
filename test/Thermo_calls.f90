...
program thermo
    ...
    cPhaseOut          = 'O2ZRU_C'
    call GetSolnPhaseMol(cPhaseOut, dDataOut, INFO)
    write(*,*) 'Phase ', cPhaseOut, ' = ', dDataOut, ' mol '
    cPhaseOut          = 'Mo5Ru3_S1(s)'
    call GetPureConPhaseMol(cPhaseOut, dDataOut, INFO)
    write(*,*) 'Phase ', cPhaseOut, ' = ', dDataOut, ' mol '

    cPhaseOut          = 'O2ZRU_C'
    iSublatticeOut  = 3
    iConstituentOut = 1
    call GetSUBLSiteFraction(cPhaseOut, iSublatticeOut, iConstituentOut, dDataOut, INFO)
    write(*,*) 'Phase ', cPhaseOut, ' = ', dDataOut, ' fraction'
    call GetSUBLStoichSublattice(cPhaseOut, iSublatticeOut, dDataOut, INFO)
    write(*,*) 'Phase ', cPhaseOut, ' = ', dDataOut, ' stoich. coeff.'
    iSublatticeOut  = 2
    iConstituentOut = 1
    call GetSUBLSiteMol(cPhaseOut, iSublatticeOut, iConstituentOut, dDataOut, INFO)
    write(*,*) 'Phase ', cPhaseOut, ' = ', dDataOut, ' mol'
