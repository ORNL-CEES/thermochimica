...
program TestParserIO01
    ...
    call ParseCSVFile(DATA_DIRECTORY // 'IO_CSV-01.csv', lPass)

    ! Test for wrong number of elements
    if (INFOThermo == 67) then
        ! The test passed:
        print *, 'TestParserIO01: PASS'
        !call ThermoDebug
        ! Reset Thermochimica:
        call ResetThermo
        call EXIT(0)
        ...
        ! The test failed.
        print *, 'TestParserIO01: FAIL <---'
        ! Reset Thermochimica:
        call ResetThermo
        call EXIT(1)
    end if
    
end program TestParserIO01
