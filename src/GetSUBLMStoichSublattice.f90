...
!-------------------------------------------------------------------------------
!
!> \file    GetSUBLMStoichSublattice.f90
!> \brief   Get the stoichiometric coefficient of a
!>          particular sublattice of a SUBLM phase.
!> \author  M.H.A. Piro
!> \date    June 10, 2016
!
!
...
subroutine GetSUBLMStoichSublattice(cSolnOut, iSublatticeOut, dStoichCoefOut, INFO)
...
end subroutine GetSUBLMStoichSublattice
