...
module ModuleThermo
    ...
    integer,       dimension(:),   allocatable::  nInterpolationOverride
    ...
    integer,       dimension(:,:,:), allocatable::  iInterpolationOverride
    ...
    real(8),       dimension(:,:), allocatable::  dStoichSpeciesUnFuzzed
