...
subroutine GetSUBLSiteMol(cSolnOut, iSublatticeOut, iConstituentOut, dSiteMolOut, INFO)
    ...
    if (INFOThermo == 0) then
        ...
        LOOP_SOLN: do i = 1, nSolnPhases
           ...
           ! write(*,*) 'O ', cTemp, len(cTemp), ' = ', cSolnPhaseName(k)
